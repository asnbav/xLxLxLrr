...
local UserName = (data.username_ or "xLxLxLrr")
...
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "xLxLxLrr")..")".."\n✫: تم رفعه "..RTPA.." هنا\n")
...
if BoykArt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"✫: العضو -› ["..result.title_.."](t.me/"..(text1[3] or "xLxLxLrr")..")".."\n✫: تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n✫> العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'xLxLxLrr')..') ~'
...
usertext = '\n✫ العضو > ['..result.title_..'](t.me/'..(username or 'xLxLxLrr')..')'
status  = '\n✫ تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'xLxLxLrr')..')'
...
local UserName = (b.username_ or "xLxLxLrr")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- ʙᴏʏᴋᴀ sᴏᴜʀᴄʀ .',url="t.me/xLxLxLrr"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,msg.id_,'✫: شترك في قناة السورس اولآ @xLxLxLrr .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ\n\n[-  ʙᴏʏᴋᴀ ᴄʜᴀɴɴᴇʟ  .](http://t.me/xLxLxLrr)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/L_A_1)\n\n[-  ʙᴏʏᴋᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/L_A_1)\n\n[-  ʙᴏᴛ ʙᴏʏᴋᴀ .](http://t.me/rriebot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: ʙᴏʏᴋᴀ sᴏᴜʀᴄʀ .',url="t.me/xLxLxLrr"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/xLxLxLrr&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
send(msg.chat_id_, msg.id_,'✫: [تحديثات البوت](t.me/xLxLxLrr) .\n - [قناه السورس](t.me/L_A_1) .')
return false  
end
...
inline = {
{{text = '✫:  - sᴏᴜʀᴄʀ ʙᴏʏᴋᴀ  .',url='http://t.me/xLxLxLrr'}},
}
